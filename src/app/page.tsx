...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-primary/10 via-background to-primary/5 min-h-[60vh] flex items-center">
      ...
      <section id="about" className="w-full bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            <h2 className="text-3xl font-bold text-gray-900">About StayFinder</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8 pt-8">
              <div className="space-y-3">
                ...
                <h3 className="font-semibold text-xl">Trusted & Secure</h3>
              ...
              <div className="space-y-3">
                ...
                <h3 className="font-semibold text-xl">Best Selection</h3>
                <p className="text-gray-600 text-sm">
      ...
      {/* Contact Us Section */}
      <section id="contact" className="w-full bg-background py-16">
        <div className="max-w-7xl mx-auto px-4">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-gray-600">support@stayfinder.com</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
                      <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-gray-600">123 Market Street<br />San Francisco, CA 94103</div>
                      </div>
                    </div>
                  </div>
                </div>
